...
import { MessageSquare, Send, X, ChevronDown, ChevronUp, Loader, ExternalLink, Volume2, Trash2 } from 'lucide-react';
...
const AIChat = () => {
    ...
    return (
        <>
            ...
            {/* Chat Window */}
            {isOpen && (
                <div className="fixed bottom-20 right-4 z-50 w-80 md:w-96 bg-white rounded-lg shadow-xl flex flex-col overflow-hidden border border-gray-200">
                    {/* Chat Header */}
                    ...
                    {!minimized && (
                        <div className="flex-1 overflow-y-auto p-3 bg-gray-50" style={{ maxHeight: '400px' }}>
                            ...
                            {isTyping && (
                                <div className="mb-3">
                                    <div className="inline-block rounded-lg p-2 bg-gray-200 text-gray-800 rounded-tl-none">
                                        <div className="flex items-center">
