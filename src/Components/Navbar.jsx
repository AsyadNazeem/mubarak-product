        ...
        <nav className="bg-gradient-to-r from-blue-700 to-blue-600 text-white shadow-lg sticky top-0 z-50">
            <div className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
                <Link to="/" className="flex items-center space-x-3 group">
                    ...
                    />
                    <span
                        className="text-xl font-semibold text-white group-hover:text-green-300 transition duration-300">
        Mubarak Products
    </span>
                </Link>
                ...
                <div className="hidden md:flex items-center space-x-8">
                    ...
                    <button
                        className="bg-green-500 hover:bg-green-600 font-medium px-5 py-2 rounded-full text-sm shadow-md hover:shadow-lg transition duration-300">
                        Shop Now
                    </button>
                </div>
            ...
            {isOpen && (
                <div
                    className="md:hidden px-6 pb-5 pt-2 flex flex-col gap-4 bg-blue-700 text-white border-t border-blue-500">
                    {navLinks.map((link) => (
                        <Link
                            key={link.name}
                            to={link.path}
                    ...
                    <button
                        className="bg-green-500 hover:bg-green-600 w-full font-medium py-3 rounded-full text-sm shadow-md hover:shadow-lg transition duration-300 mt-2">
                        Shop Now
                    </button>
                </div>
            )}
