                        ...
                        <div className="bg-white rounded-xl shadow-md p-8">
                            ...
                            <div className="mt-8 pt-6 border-t border-gray-200">
                                ...
                                <div className="flex space-x-4">
                                    ...
                                    <a href="#"
                                       className="bg-sky-400 hover:bg-sky-500 text-white p-2 rounded-full transition">
                                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path
            ...
            <div className="bg-gradient-to-br from-blue-50 to-green-50 py-16 px-6">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 text-left">
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-md">
                            <h3 className="font-bold text-lg text-gray-800 mb-2">What is the shelf life of your
                                products?</h3>
                            <p className="text-gray-600">
