        ...
        <div className="bg-gray-50 min-h-screen">
            ...
            <div className="max-w-7xl mx-auto px-6 py-16">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        <h2 className="text-3xl font-bold text-[#912923] mb-6">Our Story</h2>
                    ...
                    <div className="bg-[#F8E9E0]/20 rounded-xl p-6 shadow-inner">
                        <div className="bg-white rounded-lg shadow-md p-6 relative">
                            <div className="absolute -top-6 -left-6 bg-[#912923] rounded-full p-4 shadow-lg">
                                <Anchor size={24} className="text-white" />
                            </div>
                            <h3 className="text-xl font-semibold text-[#912923] mb-3 mt-2">Our Heritage</h3>
                            <p className="text-gray-600">
            ...
            {/* Values Section */}
            <div className="bg-gradient-to-br from-[#F8E9E0]/20 to-[#D62B31]/20 py-16 px-6">
                <div className="max-w-7xl mx-auto">
                    <h2 className="text-3xl font-bold text-[#912923] mb-8 text-center">Our Core Values</h2>

                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="bg-white p-6 rounded-xl shadow-md text-center">
                            <div className="bg-[#F8E9E0]/50 rounded-full p-4 w-16 h-16 flex items-center justify-center mx-auto mb-4">
                                <Heart size={24} className="text-[#912923]" />
                            </div>
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-md text-center">
                            <div className="bg-[#F8E9E0]/50 rounded-full p-4 w-16 h-16 flex items-center justify-center mx-auto mb-4">
                                <Shell size={24} className="text-[#912923]" />
                            </div>
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-md text-center">
                            <div className="bg-[#F8E9E0]/50 rounded-full p-4 w-16 h-16 flex items-center justify-center mx-auto mb-4">
                                <Award size={24} className="text-[#912923]" />
                            </div>
            ...
            <div className="max-w-7xl mx-auto px-6 py-16">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold text-[#912923] mb-4">Our Premium Products</h2>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    <div className="bg-white rounded-xl shadow-md overflow-hidden">
                        <div className="h-48 bg-[#F8E9E0]/30 flex items-center justify-center">
                            <Fish size={64} className="text-[#912923]" />
                        </div>
                        <div className="p-6">
                    ...
                    <div className="bg-white rounded-xl shadow-md overflow-hidden">
                        <div className="h-48 bg-[#F8E9E0]/30 flex items-center justify-center">
                            <Leaf size={64} className="text-[#D62B31]" />
                        </div>
                        <div className="p-6">
                    ...
                    <div className="bg-white rounded-xl shadow-md overflow-hidden">
                        <div className="h-48 bg-[#F8E9E0]/30 flex items-center justify-center">
                            <div className="text-[#D62B31] text-6xl font-bold">A</div>
                        </div>
                        <div className="p-6">
            ...
            {/* Team Section */}
            <div className="bg-[#912923] text-white py-16 px-6">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold mb-4">Meet Our Team</h2>
                        <p className="text-[#F8E9E0] max-w-3xl mx-auto">
                            Behind every jar of Mubarak Products is a dedicated team committed to excellence.
                        </p>
                    </div>

                    <div className="flex justify-center">
                        <div className="bg-[#D62B31] rounded-xl shadow-lg p-8 max-w-3xl">
                            <div className="flex flex-col md:flex-row items-center">
                                <div className="bg-[#D62B31]/80 rounded-full p-6 mb-6 md:mb-0 md:mr-8">
            ...
            <div className="max-w-7xl mx-auto px-6 py-16">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="bg-white p-4 rounded-lg shadow-md flex items-center justify-center aspect-square">
                                <div className="text-center">
                                    <div className="text-[#912923] font-bold text-xl mb-1">HALAL</div>
                                    <div className="text-gray-600 text-sm">Certified</div>
                                </div>
                            </div>
                            <div className="bg-white p-4 rounded-lg shadow-md flex items-center justify-center aspect-square">
                                <div className="text-center">
                                    <div className="text-[#D62B31] font-bold text-xl mb-1">ISO</div>
                                    <div className="text-gray-600 text-sm">22000:2018</div>
                                </div>
                            </div>
                            <div className="bg-white p-4 rounded-lg shadow-md flex items-center justify-center aspect-square">
                                <div className="text-center">
                                    <div className="text-[#D62B31] font-bold text-xl mb-1">HACCP</div>
                                    <div className="text-gray-600 text-sm">Compliant</div>
                                </div>
                            </div>
                            <div className="bg-white p-4 rounded-lg shadow-md flex items-center justify-center aspect-square">
                                <div className="text-center">
                                    <div className="text-[#912923] font-bold text-xl mb-1">MFD</div>
                    ...
                    <div className="order-1 md:order-2">
                        <h2 className="text-3xl font-bold text-[#912923] mb-6">Our Certifications</h2>
                        <p className="text-gray-600 mb-4">
            ...
            {/* Call to Action */}
            <div className="bg-gradient-to-r from-[#D62B31] to-[#912923] text-white py-16 px-6">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <button className="bg-white text-[#912923] hover:bg-[#F8E9E0] font-medium px-6 py-3 rounded-lg shadow-md hover:shadow-lg transition">
                            Explore Our Products
                        </button>
                        <button className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-[#912923] font-medium px-6 py-3 rounded-lg shadow-md hover:shadow-lg transition">
                            Contact Us
                        </button>
                    </div>
                </div>
